...
GOOS="linux" go build -ldflags='-s -w' -o bin/build github.com/paketo-buildpacks/sap-machine/cmd/build
GOOS="linux" go build -ldflags='-s -w' -o bin/class-counter github.com/paketo-buildpacks/libjvm/cmd/class-counter
GOOS="linux" go build -ldflags='-s -w' -o bin/detect github.com/paketo-buildpacks/sap-machine/cmd/detect
